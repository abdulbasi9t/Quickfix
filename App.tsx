...
*Instructions:* ${formData.message || 'None'}`;
  ...
  const navLinkClass = (id: string) => `hover:text-brand-accent hover:underline decoration-2 underline-offset-4 transition-all duration-300 ${activeSection === id ? 'text-brand-accent underline decoration-brand-accent' : ''}`;
  ...
  return (
    <div id="top" className="min-h-screen bg-brand-paper text-brand-black font-sans selection:bg-brand-accent selection:text-white">
      ...
      {/* Sticky Header */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-brand-paper border-b border-black flex justify-between items-center h-16 md:h-20 px-6 md:px-12 transition-all">
        <button onClick={() => window.scrollTo({top: 0, behavior: 'smooth'})} className="font-display font-bold text-2xl tracking-tighter uppercase focus:outline-none">QuickFix<span className="text-brand-accent">.</span></button>
      ...
      {/* About Grid */}
      <section id="about" className="grid md:grid-cols-2 border-b border-black">
        <div className="p-6 md:p-12 md:border-r border-black flex flex-col justify-center min-h-[50vh]">
          <h2 className="font-display text-4xl md:text-6xl font-bold uppercase mb-8">The <br/> Problem</h2>
        ...
        <div className="p-6 md:p-12 bg-white flex flex-col justify-center min-h-[50vh]">
          <h2 className="font-display text-4xl md:text-6xl font-bold uppercase mb-8 text-brand-accent">The <br/> Solution</h2>
          ...
          <ul className="space-y-4 font-medium uppercase tracking-wide text-sm">
            <li className="flex items-center gap-3"><Star size={16} className="text-brand-accent fill-brand-accent"/> 100% Background Checked</li>
            <li className="flex items-center gap-3"><Star size={16} className="text-brand-accent fill-brand-accent"/> On-Time Guarantee</li>
            <li className="flex items-center gap-3"><Star size={16} className="text-brand-accent fill-brand-accent"/> Transparent Pricing</li>
          </ul>
        </div>
      </section>
